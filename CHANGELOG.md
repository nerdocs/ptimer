...
### Added
- Initial release of Patient Timer
- Timer display in MM:SS format starting from 0:00
- Click to reset timer functionality
- Configurable warning threshold with yellow background
- Configurable critical threshold with red background
- Customizable warning and critical colors
